...
def main(argv):
	...
	plotMultipleSys(freq_prec,'No of Terms', 'Prec',argv[3]+'_freq_prec.png','Term Prediction Prec Plot');
	plotMultipleSys(freq_mrr,'No of Terms', 'MRR',argv[3]+'_freq_mrr.png','Term Prediction MRR Plot');
	plotMultipleSys(rare_prec,'No of Terms', 'Prec',argv[3]+'_rare_prec.png','Term Prediction Prec Plot ');
	plotMultipleSys(rare_mrr,'No of Terms', 'MRR',argv[3]+'_rare_mrr.png','Term Prediction MRR Plot ');
